DROP PROCEDURE IF EXISTS FetchCustomerByIdentification;
DELIMITER //

CREATE PROCEDURE `FetchCustomerByIdentification`(
...
BEGIN
    ...
    WHERE C.`IsDelete` = 0 AND C.`Identification` = p_Identification;
END //
