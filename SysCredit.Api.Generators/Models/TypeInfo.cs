namespace SysCredit.Api.Generators.Models;
...
/// </param>
internal sealed record class TypeInfo(string QualifiedName, TypeKind Kind, bool IsRecord)
{
    /// <summary>
    ///     Creates a <see cref="TypeDeclarationSyntax"/> instance for the current info.
    /// </summary>
    /// <returns>
    ///     A <see cref="TypeDeclarationSyntax"/> instance for the current info.
    /// </returns>
