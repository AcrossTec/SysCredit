...
public class CustomerEndpointTests : IClassFixture<SysCreditServerFactory<Program>>
{
    private readonly HttpClient Client;
    private readonly SysCreditServerFactory<Program> ServerFactory;

    public CustomerEndpointTests(SysCreditServerFactory<Program> ServerFactory)
    {
    ...
    [Fact]
    public async Task Get_ReferenceByCustomerIdTest()
    {
        HttpResponseMessage HttpResponse = await Client.GetAsync("/Api/Customer/1/References");
