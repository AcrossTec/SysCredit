...
public static class RoleStore
{
    ...
    public static async ValueTask<EntityId> CreateRoleAsync(this IStore<Role> Store, CreateRoleRequest Request)
    {
        ...
        {
            SysCreditException SysCreditEx = Ex.ToSysCreditException(MethodInfo.GetCurrentMethod(), DATAAR0001);
            ...
            {
                throw ExRollback.ToSysCreditException(MethodInfo.GetCurrentMethod(), DATAAR0002);
            }
