...
public static class UserStore
{
    ...
    public static async ValueTask<UserInfo> CreateUserAsync(this IStore<User> Store, CreateUserRequest Request)
    {
        ...
        {
            SysCreditException SysCreditEx = Ex.ToSysCreditException(MethodInfo.GetCurrentMethod(), DATAAU0001);
            try
            {
            ...
            {
                SysCreditEx = ExRollback.ToSysCreditException(MethodInfo.GetCurrentMethod(), DATAAU0002);
                throw SysCreditEx;
            }
            throw SysCreditEx;
        }
